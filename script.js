(function () {
  ...
  // 2. Background Ambient Video Autoplay & Android Recovery Engine
  ...
  if (bgVideo) {
    ...
    // Android/Mobile autoplay safety fallback on first user gesture
    var gestures = ['touchstart', 'touchend', 'click', 'pointerdown'];
    ...
    // Pause video when tab/app is hidden to save mobile CPU/battery
